...
class PageUserProfileEditModel extends FlutterFlowModel {
  ...
  TextEditingController? textFieldLastNameController1;
  String? Function(BuildContext, String?)?
      textFieldLastNameController1Validator;
  // State field(s) for textField_lastName widget.
  TextEditingController? textFieldLastNameController2;
  String? Function(BuildContext, String?)?
      textFieldLastNameController2Validator;
  // State field(s) for textField_lastName widget.
  TextEditingController? textFieldLastNameController3;
  String? Function(BuildContext, String?)?
      textFieldLastNameController3Validator;
  ...
  void dispose() {
    ...
    textFieldLastNameController1?.dispose();
    textFieldLastNameController2?.dispose();
    textFieldLastNameController3?.dispose();
  }
