...
class PageUserProfileEditWidget extends StatefulWidget {
  const PageUserProfileEditWidget({
    Key? key,
...
class _PageUserProfileEditWidgetState extends State<PageUserProfileEditWidget> {
  ...
  void initState() {
    ...
    _model.textFieldAboutMeController ??= TextEditingController(
      ...
      widget.myUserProfileDoc?.aboutMe,
      'n/a',
    ));
    _model.textFieldFirstNameController ??=
        TextEditingController(text: widget.myUserProfileDoc?.firstName);
    _model.textFieldLastNameController1 ??=
        TextEditingController(text: widget.myUserProfileDoc?.lastName);
    _model.textFieldLastNameController2 ??= TextEditingController(
        text: valueOrDefault<String>(
      widget.myUserProfileDoc?.satisticsHeight?.toString(),
      '0',
    ));
    _model.textFieldLastNameController3 ??= TextEditingController(
        text: valueOrDefault<String>(
      widget.myUserProfileDoc?.statisticsWeight?.toString(),
      '0',
    ));
  }
                                ...
                                children: [
                                  Expanded(
                                    child: Padding(
                                      ...
                                      child: TextFormField(
                                        controller:
                                            _model.textFieldLastNameController2,
                                        obscureText: false,
                                        decoration: InputDecoration(
                                  ...
                                  Expanded(
                                    child: Padding(
                                      ...
                                      child: TextFormField(
                                        controller:
                                            _model.textFieldLastNameController3,
                                        obscureText: false,
                                        decoration: InputDecoration(
                                          labelText: FFLocalizations.of(context)
                                              .getText(
