                    ...
                    Builder(
                      builder: (context) {
                        ...
                        return ListView.builder(
                          ...
                          itemBuilder: (context, usersFoundIndex) {
                            final usersFoundItem = usersFound[usersFoundIndex];
                            return InkWell(
                              ...
                              onTap: () async {
                                context.pushNamed(
                                  ...
                                  extra: <String, dynamic>{
                                    'userProfileDoc': usersFoundItem,
                                  },
                                );
                              },
                              child: CompUserListWidget(
                                key: Key(
                                    'Key0wh_${usersFoundIndex}_of_${usersFound.length}'),
                                documentUser: usersFoundItem,
                              ),
                            );
                          },
                        );
            ...
            Padding(
              ...
              child: FFButtonWidget(
                ...
                text: FFLocalizations.of(context).getText(
                  'gfsoiwv9' /* Meine Vereinsmitglieder */,
                ),
                icon: Icon(
                  Icons.groups,
                  size: 15.0,
