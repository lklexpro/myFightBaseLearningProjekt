...
import 'page_event_details_model.dart';
export 'page_event_details_model.dart';

class PageEventDetailsWidget extends StatefulWidget {
  const PageEventDetailsWidget({
    Key? key,
  ...
  @override
  _PageEventDetailsWidgetState createState() => _PageEventDetailsWidgetState();
}

class _PageEventDetailsWidgetState extends State<PageEventDetailsWidget> {
  late PageEventDetailsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PageEventDetailsModel());

    // On page load action.
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      _model.actionOutPutEventParticipants =
          await queryEventsParticipantsRecordOnce(
        parent: widget.documentEvent?.reference,
        singleRecord: true,
            ...
            children: [
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                if (valueOrDefault<bool>(
                                  widget.documentEvent?.hasEventPhoto() == true,
                                  false,
                                ))
                                  Padding(
                                    padding: EdgeInsetsDirectional.fromSTEB(
              ...
              Padding(
                ...
                child: InkWell(
                  ...
                  onTap: () async {
                    await _model.actionOutPutEventParticipants!.reference
                        .update({
                      'participatingUser': FieldValue.arrayUnion([
                        getParticipatingUserFirestoreData(
                          createParticipatingUserStruct(
                            user: currentUserReference,
                            userDisplayName: currentUserDisplayName,
                            userAvatar: currentUserPhoto,
                            userIsParticipating: true,
                            userParticipationSentAt: getCurrentTimestamp,
                    ...
                    await showDialog(
                      ...
                      builder: (alertDialogContext) {
                        return AlertDialog(
                          ...
                          content: Text(
                              'Du hast dich für dieses Event registriert!'),
                          actions: [
                            TextButton(
                              onPressed: () =>
