                                ...
                                child: Padding(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      Text(
                                        FFLocalizations.of(context).getText(
                                          'h8wfyg6b' /* Private Veranstaltung */,
                                        ),
                          ...
                          Row(
                            ...
                            children: [
                              Flexible(
                                child: Text(
                                  FFLocalizations.of(context).getText(
                                    'uiu32qqz' /* Vereinsmitglieder einladen:  */,
                                  ),
                                  textAlign: TextAlign.center,
                                  maxLines: 2,
                                  style:
                                        ...
                                        builder: (context) {
                                          return Padding(
                                            ...
                                            child:
                                              ...
                                              selectAllMembersAppState: FFAppState()
                          ...
                          Row(
                            ...
                            children: [
                              Flexible(
                                child: Text(
                                  FFLocalizations.of(context).getText(
                                    '5gs11a5a' /* Weitere Personen einladen:  */,
                                  ),
                                  textAlign: TextAlign.center,
                                  maxLines: 2,
                                  style:
                                      ...
                                      await showModalBottomSheet(
                                        ...
                                        builder: (context) {
                                          return Padding(
                                            padding: MediaQuery.viewInsetsOf(
                                                context),
                                            child: CompUserSelectionWidget(),
                                          );
                                        },
                                      ).then((value) => setState(() {}));

                                      setState(() {
                                        _model.countInvitedFollowers =
                                            valueOrDefault<int>(
                                          FFAppState()
                                  ...
                                  child: Padding(
                                    ...
                                    child: FFButtonWidget(
                                      onPressed: () async {
                                        ...
                                        await eventsRecordReference
                                          ...
                                          eventParticipationFee:
                                              double.tryParse(_model
                                                  .eventPartFeeController.text),
                                          eventIsPrivate:
                                              _model.eventIsPrivateValue,
                                          eventNeedsRegistration:
                                              _model.eventRegistriationReqValue,
                                          eventTimeCreated: getCurrentTimestamp,
                                          creatorDisplayName:
                                        ...
                                        await EventsParticipantsRecord
                                                .createDoc(_model
                                                    .createdEventDoc!.reference)
                                            .set(
                                                createEventsParticipantsRecordData());
                                        Navigator.pop(context);
                                        setState(() {
                                          _model.eventNameController?.clear();
                                          _model.descriptionController?.clear();
                                          _model.eventLocationController
                                              ?.clear();
                                          _model.eventPartFeeController
                                              ?.clear();
                                        });
