...
DocumentReference? get currentUserReference =>
    loggedIn ? AllUsersRecord.collection.doc(currentUser!.uid) : null;

AllUsersRecord? currentUserDocument;
final authenticatedUserStream = FirebaseAuth.instance
    ...
    .switchMap(
      (uid) => uid.isEmpty
          ? Stream.value(null)
          : AllUsersRecord.getDocument(AllUsersRecord.collection.doc(uid))
              .handleError((_) {}),
    )
