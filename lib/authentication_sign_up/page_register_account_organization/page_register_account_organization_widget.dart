                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      Padding(
                                        ...
                                        child: Text(
                                          FFLocalizations.of(context).getText(
                                            '3g2knetn' /* Registriere deinen Verein bei ... */,
                                          ),
                                          textAlign: TextAlign.start,
                                          style: FlutterFlowTheme.of(context)
                                              .labelLarge,
                                        ...
                                        child: Padding(
                                          ...
                                          child: FlutterFlowDropDown<String>(
                                            ...
                                            optionLabels: [
                                              FFLocalizations.of(context)
                                                  .getText(
                                                '26wz9qnl' /* Sportverein */,
                                              ),
                                              FFLocalizations.of(context)
                                                  .getText(
                                                'l2cyz1kd' /* Fitnessstudio */,
                                              ),
                                              FFLocalizations.of(context)
                                                  .getText(
                                                'aguos8jn' /* Gemeinnütziger Verein */,
                                              )
                                            ],
                                                ...
                                                children: [
                                                  TextSpan(
                                                    text: FFLocalizations.of(
                                                            context)
                                                        .getText(
                                                      '1btiv7p1' /* Du hast bereits einen Account?... */,
                                                    ),
                                                    style: TextStyle(),
                                                  ),
                                                  TextSpan(
